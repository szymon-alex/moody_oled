...
try:
    ...
    while not killer.kill_now:
        ...
        for line in range(0,len(state_list)):
            ...
            # [sz] voluem change disabled, 100% set
            vol_val = '100'
        ...
        # Play screen
            ...
            if info_file != music_file or time_bar < 5 :
                ...
                #bit_val = str.encode(bit_val)
                #samp_val = str.encode(samp_val)                 
                artist_offset    = 10;
                album_offset    = 10;
                title_offset     = 10;
            ...
            if screen_sleep < 20000 :
                with canvas(device) as draw:
                    #draw.text((14, 0),"Szymon Pi", font=font_logo,fill="white")
                    if ip != "":
